...
class ChatUser
{
	...
	{
		$query = "
		INSERT INTO usuarios (user_name, user_email, user_password, user_profile, user_status, user_created_on, user_verification_code) 
	...
	{
		$query = "
		SELECT id, nome, user_login_status, (SELECT COUNT(*) FROM chat_message WHERE to_user_id = :user_id AND from_user_id = usuarios.id AND status = 'No') AS count_status FROM usuarios
		";
