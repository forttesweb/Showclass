...
class PrivateChat
{
	...
	function setAnuncioId($id_anuncio)
	{
	...
	function save_chat()
	{
		...
		INSERT INTO chat_message 
			(id_anuncio, to_user_id, from_user_id, chat_message, timestamp, status) 
			VALUES (:id_anuncio, :to_user_id, :from_user_id, :chat_message, :timestamp, :status)
		";

		$statement = $this->connect->prepare($query);

		$statement->bindParam(':id_anuncio', $this->id_anuncio);
